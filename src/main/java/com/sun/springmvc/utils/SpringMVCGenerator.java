...
public class SpringMVCGenerator {
    ...
    private static final String DB_JDBC_URL = "jdbc:mysql://localhost/ylj?useUnicode=true&useSSL=false&characterEncoding=utf8";
    private static final String DB_USERNAME = "root";
    private static final String DB_PASSWORD = "haylion123";

    private static final String GEN_PATH = new File("spring-mvc").getAbsolutePath();
    private static final String PACKAGE_NAME = "com.sun.springmvc";
    private static final String AUTHOR_NAME = "sunzhongshu";
    private static final String[] TABLE_PREFIXS = {"tb_dw_"};
